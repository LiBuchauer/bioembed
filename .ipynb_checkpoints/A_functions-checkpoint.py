## adapted from https://github.com/RemiLehe/transparent_imshow/blob/master/transparent_imshow/transparent_imshow.py
"""
...
def transp_imshow( data, tvmin=None, tvmax=None, tmax=1., ax=None,
